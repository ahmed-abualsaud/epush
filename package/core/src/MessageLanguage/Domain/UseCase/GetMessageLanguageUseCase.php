...
class GetMessageLanguageUseCase
{
    ...
    public function execute(MessageLanguageDto $messageLanguageDto): array
    {
        $this->validationService->validate($messageLanguageDto->toArray(), MessageLanguageDto::rules());
        return $this->messageLanguageService->get($messageLanguageDto->getMessageLanguageID());
    }
}