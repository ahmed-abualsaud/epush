...
class SettingsController
{
    ...
    {
        return jsonResponse($updateSettingsUseCase->execute($settingsDto, $updateSettingsDto));
    }

    #[Delete('{settings_id}')]
    public function deleteSettings(SettingsDto $settingsDto, DeleteSettingsUseCase $deleteSettingsUseCase): Response
    {
        return jsonResponse($deleteSettingsUseCase->execute($settingsDto));
    }
    ...
    {
        return jsonResponse($searchSettingsUseCase->execute($searchSettingsDto));
    }
}