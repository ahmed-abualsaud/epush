      ...
      <tbody>
        ...
        <tr>
          <td style="font-size: 16px; padding: 40px; background-color: #fff; color: #000;">
            ...
            <strong>Order Cost:</strong> {{ $order['credit'] }}<br/><br/>
            <strong>Message Price:</strong> {{ $order['price'] }}<br/><br/>
            <strong>Your Balance:</strong> {{ $order['balance'] }}<br/><br/>
            <strong>Number Of Messages:</strong> {{ $order['messages_count'] }}<br/><br/>
            Best Regards <br/>
            E-push team
          </td>
        </tr>
